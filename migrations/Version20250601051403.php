 ...
 */
final class Version20250601051403 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE order_item (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, _order_id INTEGER NOT NULL, product_id INTEGER NOT NULL, qte INTEGER NOT NULL, unit_price NUMERIC(6, 2) NOT NULL, CONSTRAINT FK_52EA1F09A35F2858 FOREIGN KEY (_order_id) REFERENCES "order" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_52EA1F094584665A FOREIGN KEY (product_id) REFERENCES product (id) NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        $this->addSql(<<<'SQL'
            ...
            , password VARCHAR(255) NOT NULL, phone VARCHAR(20) DEFAULT NULL, CONSTRAINT FK_8D93D6491AD5CDBF FOREIGN KEY (cart_id) REFERENCES cart (id) NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
